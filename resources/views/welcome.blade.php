        ...
        <header class="border-b border-slate-200 bg-white/80 backdrop-blur sticky top-0 z-50">
            ...
            <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="h-11 w-11 rounded-xl bg-blue-600 flex items-center justify-center text-white font-bold text-xl shadow">
                        M
                    </div>
                ...
                <nav class="hidden md:flex items-center gap-8 text-sm text-slate-600">
                    ...
                    <a href="#roles" class="hover:text-blue-600 transition">
                        Roles
                    </a>
                ...
                <div>
                    ...
                    <a
                        href="{{ route('login') }}"
                        class="inline-flex items-center rounded-lg bg-blue-600 px-5 py-2.5 text-white font-medium hover:bg-blue-700 transition"
                    >
                        Login
                    </a>
            ...
            <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <span class="inline-flex rounded-full bg-blue-100 text-blue-700 px-4 py-1 text-sm font-medium mb-6">
                            Laravel 13 • Electronic Medical Record
                        </span>
                        ...
                        <p class="mt-8 text-lg text-slate-600 leading-8">
                            ...
                            MediFlow helps clinics manage patients, registrations,
                            examinations, medical records, billing, pharmacy,
                            cashier operations, and operational reporting through a
                        ...
                        <div class="mt-10 flex flex-wrap gap-4">
                            ...
                            <a
                                href="#features"
                                class="rounded-xl border border-slate-300 bg-white px-6 py-3 font-semibold hover:bg-slate-100 transition"
                            >
                                Explore Features
                            </a>
                        ...
                        <div class="rounded-3xl bg-white shadow-xl border border-slate-200 overflow-hidden">
                            ...
                            <div class="bg-blue-600 px-6 py-5">
                                ...
                                <p class="text-blue-100 text-sm mt-1">
                                    End-to-end clinic operational workflow
                                </p>
                            ...
                            <div class="p-8 space-y-5">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span>🏥 SATUSEHAT Foundation</span>
            ...
            <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="text-center max-w-3xl mx-auto">
                    ...
                    <h2 class="mt-4 text-4xl font-bold text-slate-900">
                        Everything Needed to Run a Modern Clinic
                    </h2>

                    <p class="mt-6 text-lg text-slate-600">
                        MediFlow centralizes clinic operations from patient
                        registration to billing, pharmacy, reporting, and
                        SATUSEHAT foundation integration.
                    </p>
                ...
                <div class="mt-16 grid md:grid-cols-2 xl:grid-cols-3 gap-8">
                    ...
                    {{-- Card --}}
                    <div class="rounded-2xl border border-slate-200 bg-slate-50 p-7 hover:shadow-lg transition">
                        ...
                        <p class="mt-3 text-slate-600">
                            Complete patient registration, medical record numbers,
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-slate-50 p-7 hover:shadow-lg transition">
                        ...
                        <p class="mt-3 text-slate-600">
                            Automatic queue generation, registration workflow,
                            patient tracking, and queue status management.
                        </p>
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-slate-50 p-7 hover:shadow-lg transition">
                        ...
                        <p class="mt-3 text-slate-600">
                            Digital examination workflow with diagnosis,
                            vital signs, prescriptions, and medical records.
                        </p>
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-slate-50 p-7 hover:shadow-lg transition">
                        ...
                        <p class="mt-3 text-slate-600">
                            Invoice generation, QRIS, transfer, cash payment,
                            approval workflow, receipts, and refunds.
                        </p>
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-slate-50 p-7 hover:shadow-lg transition">
                        ...
                        <p class="mt-3 text-slate-600">
                            ...
                            reconciliation reports, expected balance,
                            and daily closing reports.
                        </p>
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-slate-50 p-7 hover:shadow-lg transition">
                        ...
                        <p class="mt-3 text-slate-600">
                            ...
                            and cashier reconciliation exports.
                        </p>
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-gradient-to-br from-blue-600 to-indigo-600 p-7 text-white shadow-lg">
            ...
            <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="text-center mb-14">
                    ...
                    <p class="mt-4 text-gray-600 max-w-2xl mx-auto">
                        MediFlow streamlines the complete outpatient workflow—from patient
                        registration until payment and reporting.
                    </p>
                ...
                <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="bg-gray-50 rounded-2xl p-8 border hover:border-blue-500 transition">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            Manage patient records, medical record numbers, demographics,
                            and visit history efficiently.
                        </p>
                    ...
                    <div class="bg-gray-50 rounded-2xl p-8 border hover:border-blue-500 transition">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            Doctors can document examinations, diagnoses, vital signs,
                    ...
                    <div class="bg-gray-50 rounded-2xl p-8 border hover:border-blue-500 transition">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            Generate invoices, receive payments, manage refunds, and
                    ...
                    <div class="bg-gray-50 rounded-2xl p-8 border hover:border-blue-500 transition">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            Medication catalog, stock adjustment, stock movement, and
                    ...
                    <div class="bg-gray-50 rounded-2xl p-8 border hover:border-blue-500 transition">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            Financial reports, patient reports, registration reports,
                            medical record reports, and cashier reconciliation.
                        </p>
                    ...
                    <div class="bg-gray-50 rounded-2xl p-8 border hover:border-blue-500 transition">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            Role-based permissions, activity logs, media library,
                            and secure authentication powered by Laravel.
                        </p>
            ...
            <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="text-center mb-16">
                    ...
                    <p class="mt-4 text-slate-600 max-w-3xl mx-auto">
                        MediFlow streamlines every patient visit from registration
                        to payment using a structured workflow.
                    </p>
                ...
                <div class="grid md:grid-cols-7 gap-4 items-center">
                    ...
                    <div class="text-center text-2xl text-slate-400">
                        →
                    </div>
        ...
        <section id="roles" class="py-24 bg-white">
            ...
            <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="text-center mb-16">
                    ...
                    <p class="mt-4 text-slate-600 max-w-3xl mx-auto">
                        Every user only accesses features according to their responsibilities.
                    </p>
            ...
            <div class="max-w-7xl mx-auto px-6 py-12">
                ...
                <div class="flex flex-col md:flex-row justify-between gap-8">
                    ...
                    <div>
                        ...
                        <p class="mt-4 max-w-md leading-relaxed">
                            Modern Clinic Management Information System built with
                            Laravel 13 to simplify outpatient clinical operations.
                        </p>
