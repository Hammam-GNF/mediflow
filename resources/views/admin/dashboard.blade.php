    ...
    <div class="py-8">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            @if($currentShift)
                ...
                <section
                    class="rounded-3xl bg-white border border-slate-200 shadow-sm p-8"
                >
                    ...
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500 mt-1">
                                Current active cashier session
                            </p>

                        </div>

                        <span
                            class="inline-flex items-center gap-2 rounded-full bg-green-100 px-4 py-2 text-green-700 font-semibold"
                        >
